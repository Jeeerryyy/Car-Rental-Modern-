export const getInvoiceHtml = (booking) => {
  ...
  // Back-calculate subtotal and rate if necessary
  const subtotal = grandTotal + discount;
  const ratePerDay = car.pricePerDay || (subtotal / totalDays);
  
  const promoInfo = booking.promoCode ? ` (Code: ${booking.promoCode})` : '';
        ...
        <div class="page-content">
            ...
            <div class="summary-box">
                ...
                <div class="summary-details">
                    ...
                    <div class="summary-line">
                        <span>Discount / Coupon${promoInfo}</span>
