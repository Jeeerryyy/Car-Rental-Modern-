        ...
        <div className="xl:col-span-2 space-y-8">
          <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-6 md:p-8 space-y-8 shadow-sm">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" value={form.make} onChange={set('make')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-black text-secondary uppercase tracking-widest mb-2">Model</label>
                  <input type="text" value={form.model} onChange={set('model')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-black text-secondary uppercase tracking-widest mb-2">Year</label>
                  <input type="number" value={form.year} onChange={set('year')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-black text-secondary uppercase tracking-widest mb-2">Category</label>
                  <select value={form.category} onChange={set('category')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all">
            ...
            <div className="pt-6 border-t border-outline-variant">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <select value={form.fuelType} onChange={set('fuelType')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all">
                ...
                {car.type !== 'bike' && (
                  <>
                    <div>
                      ...
                      <select value={form.transmission} onChange={set('transmission')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all">
                        {TRANSMISSIONS.map(t => <option key={t} value={t}>{t}</option>)}
                      </select>
                    </div>
                    <div>
                      <label className="block text-xs font-black text-secondary uppercase tracking-widest mb-2">Drive Option</label>
                      <select value={form.driveOption} onChange={set('driveOption')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all">
            ...
            <div className="pt-6 border-t border-outline-variant">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input type="number" value={form.pricePerDay} onChange={set('pricePerDay')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
                </div>
                {car.type !== 'bike' && (
                  <div>
                    <label className="block text-xs font-black text-secondary uppercase tracking-widest mb-2">Seats</label>
                    <input type="number" value={form.seats} onChange={set('seats')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
                  </div>
                )}
                <div>
                  <label className="block text-xs font-black text-secondary uppercase tracking-widest mb-2">Location</label>
                  <input type="text" value={form.location} onChange={set('location')} className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-outline-variant">
              ...
              <textarea value={form.description} onChange={set('description')} rows="4" className="w-full px-4 py-3 border border-outline-variant rounded-xl text-sm bg-surface outline-none focus:border-primary transition-all" />
            </div>
