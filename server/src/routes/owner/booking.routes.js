...
import { forOwner, updateStatus, manual, uploadOwnerDocuments, remove, searchCustomer, lookupCustomerByPhone } from '../../controllers/booking.controller.js';
...
router.get('/customer-by-phone', lookupCustomerByPhone);
